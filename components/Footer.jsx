...
const Footer = () => {
  return (
    ...
    <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
      <div className=" flex justify-center  items-center font-bold text-xl gap-0">
      <img src="/logo2.svg" alt="logo-svg" className="w-12 h-12 mr-10" /> 
      <h4>Pcodes</h4>
      </div>
      
      <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500">
      MADE IN EUROPE. INSPIRED EVERYWHERE.
      </p>
      ...
      <ul className="mt-12 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
        ...
        <li>
          <a className="text-gray-700 transition hover:text-gray-700/75" href="/work"> Projects </a>
        </li>
